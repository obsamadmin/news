...
public class NewsTargetingServiceImpl implements NewsTargetingService {
  ...
  @Override
  public void saveNewsTarget(String newsId, List<String> targets, String currentUserId) throws IllegalAccessException {
    ...
    targets.stream().forEach(targetName -> {
      try {
        ...
        metadataService.createMetadataItem(newsTargetObject, metadataKey, Long.parseLong(currentSocIdentity.getId()));
